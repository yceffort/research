...
- 🕐 **시간 절약**: "그 유틸 어디있더라" 찾는 시간 감소
- 📚 **온보딩 개선**: 신규 입사자의 코드베이스 학습 가속
- 🔄 **재사용성 향상**: 이미 있는 유틸 재발명 방지
- 💡 **지식 전파**: 다른 팀의 좋은 패턴 자연스럽게 확산
...
- Pie Bot은 단순한 "LLM 붙인 챗봇"이 아니라  
  → **개발 워크플로우에 깊이 통합되는 RAG 기반 도구**로 진화 중임

- 검색 정확도, 생성 품질, 사용자 편의성, 확장성 모두 고려한  
  **장기적 기술 투자 로드맵을 실현 중임**
